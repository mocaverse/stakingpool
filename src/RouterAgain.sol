...
//------------------------------- constructor -------------------------------------------
    ...
    function createVault(DataTypes.VaultDuration duration, uint256 creatorFeeFactor, uint256 nftFeeFactor, uint8 v, bytes32 r, bytes32 s) external {
    ...
    function updateNftFee(bytes32 vaultId, uint256 amount, uint256 realmId, uint8 v, bytes32 r, bytes32 s) external {
        ...
        POOL.updateNftFee(bytes32 vaultId, msg.sender, uint256 amount);
    }
    ...
    function updateCreatorFee(bytes32 vaultId, uint256 amount, uint256 realmId, uint8 v, bytes32 r, bytes32 s) external {
        ...
        POOL.updateCreatorFee(bytes32 vaultId, msg.sender, uint256 amount);
    }
    ...
    function increaseVaultLimit(bytes32 vaultId, uint256 amount, uint256 realmId, uint8 v, bytes32 r, bytes32 s) external {
        ...
        POOL.increaseVaultLimit(bytes32 vaultId, msg.sender, uint256 amount);
    }
